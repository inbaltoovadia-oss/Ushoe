...
import { Search, Heart, MapPin, Sun, Moon, Sparkles, Menu, X } from "lucide-react";
...
export default function Navbar() {
  ...
  useEffect(() => {
    return subscribeLocation(setLoc);
  }, []);
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2 group">
            ...
            <span className="font-heading font-bold text-lg tracking-tight">
              ShoeFinder<span className="text-primary">AI</span>
            </span>
          </Link>
          ...
          <div className="flex items-center gap-2">
            <button
              onClick={() => {}}
              className="hidden sm:flex items-center gap-1.5 text-xs text-muted-foreground hover:text-foreground transition-colors px-3 py-1.5 rounded-lg bg-secondary/50"
            >
